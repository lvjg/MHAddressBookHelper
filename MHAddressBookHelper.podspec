#
#  Be sure to run `pod spec lint MHAddressBookHelper.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "lvjigen" => "lvjg0304@gmail.com" }
  # Or just: s.author    = "lvjigen"
  # s.authors            = { "lvjigen" => "lvjg0304@gmail.com" }
  # s.social_media_url   = "http://twitter.com/lvjigen"
  ...
  # s.frameworks = "AddressBook", "AnotherFramework"
